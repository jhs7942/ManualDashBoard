            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="ui"><i class="fa fa-table "></i>UI Elements  <span class="badge">Included</span></a>
                    </li>
                    <li>
                        <a href="blank"><i class="fa fa-edit "></i>Blank Page  <span class="badge">Included</span></a>
                    </li>
  ...
  <span class="input-group-addon">.00</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <a href="blank" target="_blank" class="btn btn-danger btn-lg btn-block">BLANK PAGE</a>
                    </div>
                    <div class="col-lg-4 col-md-4">
